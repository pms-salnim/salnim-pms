...
exports.dynamicVariables = exports.emailTemplateTypes = void 0;
exports.emailTemplateTypes = [
    {
        type: "reservation_confirmation",
        name: "Reservation Information Email",
        description: "Sent automatically to the GUEST when a reservation is completed online or manually.",
    ...
    },
    {
        ...
        description: "Sent to the GUEST when their booking is successfully created.",
    ...
    },
    {
        ...
        description: "Sent to the GUEST when a reservation's details are modified by staff.",
    ...
    },
    {
        ...
        name: "Bank Transfer Information Email",
        description: "Provides payment instructions for guests paying via bank transfer.",
        defaultSubject: "Payment Instructions for Your Booking",
        defaultBody: "Dear {{guest_name}},\n\nPlease use the following details to complete your payment via bank transfer for reservation {{reservation_code}}.\n\nBank: [Your Bank Name]\nAccount: [Account Number]\nSwift/BIC: [Code]\nReference: {{reservation_code}}"
    },
    {
        type: "mail_order_info",
        name: "Mail Order Information Email",
    ...
    },
    {
        ...
        defaultSubject: "Invoice {{invoice_number}} from {{property_name}}",
        defaultBody: "Dear {{guest_name}},\n\nPlease find your invoice attached.\n\nRoom Number: {{room_number}}{{extras}}\n\nThank you for your business!\n\nBest regards,\n{{property_name}}"
    },
    {
...
exports.dynamicVariables = [
    ...
    { variable: "price_per_night", description: "The average room rate per night (before tax).", sampleValue: "$150.00" },
