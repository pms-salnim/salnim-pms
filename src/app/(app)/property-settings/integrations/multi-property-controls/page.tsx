...
export default function MultiPropertyControlsPage() {
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="rounded-lg border bg-white p-6">
          <h2 className="text-lg font-semibold mb-4">Multi-Property Controls</h2>
          <p className="text-sm text-muted-foreground">Manage settings and operations across multiple properties.</p>
        </div>
      </div>
    </div>
  );
