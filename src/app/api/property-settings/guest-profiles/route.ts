/**
 * Guest Profile Settings API Routes
 * GET: Fetch guest profile settings for property
 * POST: Save guest profile settings for property
 * 
...
/**
 * GET Handler - Retrieve guest profile settings for a property
 */
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch guest profile settings for the property
...
/**
 * POST Handler - Save guest profile settings for a property
 */
