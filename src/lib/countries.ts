...
export const countries: Country[] = [
    ...
    { name: 'Bermuda', code: 'BM', phone: '1-441' },
    { name: 'Bhutan', code: 'BT', phone: '975' },
    { name: 'Bolivia', code: 'BO', phone: '591' },
    { name: 'Bosnia and Herzegovina', code: 'BA', phone: '387' },
    { name: 'Botswana', code: 'BW', phone: '267' },
    { name: 'Bouvet Island', code: 'BV', phone: '47' },
    ...
    { name: 'Congo, The Democratic Republic of the', code: 'CD', phone: '243' },
    ...
    { name: 'Heard Island and Mcdonald Islands', code: 'HM', phone: '672' },
    { name: 'Holy See (Vatican City State)', code: 'VA', phone: '379' },
    ...
    { name: 'Montserrat', code: 'MS', phone: '1-664' },
    ...
    { name: 'Northern Mariana Islands', code: 'MP', phone: '1-670' },
    ...
    { name: 'Pitcairn', code: 'PN', phone: '870' },
    ...
    { name: 'Turks and Caicos Islands', code: 'TC', phone: '1-649' },
    ...
    { name: 'Virgin Islands, British', code: 'VG', phone: '1-284' },
    { name: 'Virgin Islands, U.S.', code: 'VI', phone: '1-340' },
