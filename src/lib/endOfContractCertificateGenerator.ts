...
export async function generateEndOfContractCertificatePdf(
  ...
  yOffset += drawTextWithHighlights(doc, textWithoutTags(content.status), highlights, margin + 10, yOffset, contentWidth - 10);
  yOffset += 7;
