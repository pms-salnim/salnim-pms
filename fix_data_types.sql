-- Direct fix for availability_restrictions and rate_overrides tables
-- Run this directly in Supabase SQL editor to fix the data type issues

-- Drop the incorrectly typed tables
